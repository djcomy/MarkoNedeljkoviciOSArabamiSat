...
extension HomeController {
    ...
    func loadUserData() {
        ...
        if Reachability.isConnectedToNetwork() {
            ...
            self.carsViewModel = realmStoredResults.map { data -> CarsViewModel in
                ...
                return CarsViewModel(car: Car(carBrand: carBrand, carModel: carModel, carBirth: carBirth, carPower: carPower, carCapacity: carCapacity, carPrice: carPrice, carKMPassed: carKMPassed, carDesc: carDesc, photoURL: photoUrl))
            }
