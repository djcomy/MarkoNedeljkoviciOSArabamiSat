...
class LoginController: UIViewController {
   ...
   // let myPrimaryKey = Person.primaryKey()
    ...
    lazy var dividerView: UIView = {
        ...
        separator1.anchor(top: nil, left: dividerView.leftAnchor, bottom: nil, right: label.leftAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 8, width: 0, height: 1.0)
        ...
        separator2.anchor(top: nil, left: label.rightAnchor, bottom: nil, right: dividerView.rightAnchor, paddingTop: 0, paddingLeft: 8, paddingBottom: 0, paddingRight: 0, width: 0, height: 1.0)
...
extension LoginController: GIDSignInDelegate {
    func sign(_ signIn: GIDSignIn!, didSignInFor user: GIDGoogleUser!, withError error: Error?) {
        ...
        Auth.auth().signIn(with: credential) { (result, error) in
            if let error = error {
                print("Failed to sign in and retrieve data", error)
                return
            } else {
